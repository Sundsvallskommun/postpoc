...
class DigitalRegisteredLetterConfigurationTest {
	...
	@Mock
	private DigitalRegisteredLetterProperties propertiesMock;

	@Test
	void testFeignBuilderCustomizer() {
		final var configuration = new DigitalRegisteredLetterConfiguration();
