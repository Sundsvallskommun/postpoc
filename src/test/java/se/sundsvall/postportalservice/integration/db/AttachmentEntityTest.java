...
class AttachmentEntityTest {
	...
	private static final String NAME = "attachment.txt";
	private static final String MIME_TYPE = "text/plain";
	private static final String CONTENT = "This is a test attachment content.";
	...
	void setterAndGetterTest() {
		...
		attachmentEntity.setMimeType(MIME_TYPE);
		attachmentEntity.setContent(CONTENT);
		attachmentEntity.setCreated(CREATED);

		assertThat(attachmentEntity.getId()).isEqualTo(ID);
		assertThat(attachmentEntity.getName()).isEqualTo(NAME);
		assertThat(attachmentEntity.getMimeType()).isEqualTo(MIME_TYPE);
